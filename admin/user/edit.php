    ...
    <div class="col-md-8 col-sm-12">
        <form action="./user/update.php" method="post" class="form-horizontal">
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <input class="form-control" type="number" name="nim" placeholder="NIM" type="number" readonly value="<?php echo $id_user; ?>"/>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-8">
                    <input class="form-control" name="nama" type="text" placeholder="Nama Mahasiswa" value="<?php echo $fullname; ?>"/>
                </div>
            </div>
