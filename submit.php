<?php
session_start();
if(!isset($_SESSION['mahasiswa']) || !isset($_GET['id'])) {
   header('location:./');
}
...
//simpan data pemilih
$save = $con->prepare("INSERT INTO t_pemilih(nim, periode) VALUES(?,?)") or die($con->error);
$save->bind_param('ss', $_SESSION['mahasiswa'], $periode);
$save->execute();
