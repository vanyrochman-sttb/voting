...
<h2 class="index-header">Selamat Datang di Aplikasi E - Voting<br/></h2>
<div class="row">
    <div class="col-md-4 col-md-offset-1">
        <div id="content-slider">
            <img src="./assets/img/sttb.png" class="img" alt="Slideshow 2" >
    ...
    <div class="col-md-6 form">
        ...
        <form action="" method="post">
            <div class="form-group">
                ...
                <input type="number" class="form-control" placeholder="NIM" required="NIM" name="nim"/>
            </div>
            <br />
            <div class="row">
